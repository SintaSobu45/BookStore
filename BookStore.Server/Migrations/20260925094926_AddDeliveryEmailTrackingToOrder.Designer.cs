...
namespace BookStore.Server.Migrations
{
    ...
    [Migration("20260925094926_AddDeliveryEmailTrackingToOrder")]
    partial class AddDeliveryEmailTrackingToOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Server.Models.BookPayment.BookPayment", b =>
                {
                    b.Property<int>("BookPaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BookPaymentId"));
            ...
            modelBuilder.Entity("BookStore.Server.Models.Certificate", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Server.Models.Logo", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Server.Models.OrderModel.Order", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DeliveryEmailSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BookStore.Server.Models.OrderModel.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BookStore.Server.Models.PageWarning", b =>
                {
                    b.Property<int>("PageWarningId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PageWarningId"));
                    ...
                    b.HasKey("PageWarningId");

                    b.ToTable("PageWarnings");
                });
            ...
            modelBuilder.Entity("BookStore.Server.Models.PromotionBanner", b =>
                {
                    b.Property<int>("PromotionBannerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PromotionBannerId"));
            ...
            modelBuilder.Entity("BookStore.Server.Models.StoryPoetry", b =>
                {
                    ...
                    b.Property<string>("ContributorPincode")
                        .IsRequired()
                        .HasMaxLength(6)
                    ...
                    b.Property<string>("ParticularNameSnapshot")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<DateTime?>("PaymentEnabledAt")
                        .HasColumnType("datetime2");

                    b.Property<bool>("PaymentNotificationSent")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("SpOrderStatus")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");

                    b.Property<int>("StoryPoetryParticularId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StoryPoetryParticularId");
            ...
            modelBuilder.Entity("BookStore.Server.Models.StoryPoetryCopySetting", b =>
                {
                    b.Property<int>("StoryPoetryCopySettingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StoryPoetryCopySettingId"));
                    ...
                    b.HasKey("StoryPoetryCopySettingId");

                    b.HasIndex("Type")
                        .IsUnique();

                    b.ToTable("StoryPoetryCopySettings");
                });

            modelBuilder.Entity("BookStore.Server.Models.StoryPoetryParticular", b =>
                {
                    b.Property<int>("StoryPoetryParticularId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("StoryPoetryParticularId"));
                    ...
                    b.HasKey("StoryPoetryParticularId");

                    b.ToTable("StoryPoetryParticular");
                });
            ...
            modelBuilder.Entity("BookStore.Server.Models.BookPayment.BookPayment", b =>
                {
                    b.HasOne("BookStore.Server.Models.OrderModel.Order", "Order")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Server.Models.Certificate", b =>
                {
                    b.HasOne("BookStore.Server.Models.StoryPoetry", "StoryPoetry")
                        .WithOne("Certificate")
                        .HasForeignKey("BookStore.Server.Models.Certificate", "StoryPoetryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookStore.Server.Models.StoryPoetry", b =>
                {
                    b.HasOne("BookStore.Server.Models.StoryPoetryParticular", "StoryPoetryParticular")
                        .WithMany("StoryPoetries")
                        .HasForeignKey("StoryPoetryParticularId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("StoryPoetryParticular");

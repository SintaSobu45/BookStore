        ...
        {!loading && error && (
          <div className="rounded-xl sm:rounded-2xl border border-red-200 bg-red-50 p-3.5 sm:p-5">
            <div className="flex items-start gap-2.5 sm:gap-3">
              <AlertCircle
                size={20}
                className="text-red-600 shrink-0 mt-0.5 sm:w-5 sm:h-5"
              />
              <div>
                <h3 className="text-sm sm:text-base font-semibold text-red-800">
                  Unable to load your uploads
                </h3>
                <p className="mt-0.5 text-xs sm:text-sm text-red-700">
                  {error}
                </p>
              </div>
            </div>
                  ...
                  <div className="p-3.5 sm:p-7">
                    ...
                    {!paymentAvailable && !paymentCompleted && (
                      <div className="mt-3 sm:mt-6 rounded-xl sm:rounded-2xl border border-red-200 bg-red-50 p-3 sm:p-5">
                        <div className="flex items-start gap-2.5 sm:gap-3">
                          <div className="text-base sm:text-xl shrink-0">
                            ⚠️
                          </div>
                          <div>
                      ...
                      <div className="mt-3 sm:mt-6 pt-3 sm:pt-6 border-t border-gray-100">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 sm:gap-5">
                          ...
                          <button
                            onClick={() =>
                              navigate(
                                `/your/uploads/payment/${upload.storyPoetryId}`,
                              )
                            }
                            className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 sm:px-7 sm:py-3.5 rounded-xl bg-[#1b3b2b] text-white text-sm sm:text-base font-bold hover:bg-[#123022] transition shadow-sm active:scale-[0.99]"
                          >
                            <CreditCard
                              size={16}

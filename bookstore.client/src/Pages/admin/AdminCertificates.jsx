    ...
    <div className="p-4 md:p-6 mt-5">
      ...
      {loading ? (
        ...
        <div className="bg-white border border-stone-200 rounded-2xl p-12 text-center">
          ...
          <h3 className="font-bold text-gray-900">No candidates available</h3>
          <p className="text-sm text-stone-500 mt-1">
            All paid contributors have already received their certificates.
          </p>
        </div>
      ) : (
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-stone-500 mt-0.5">
                  {filteredSubmissions.length} candidate(s) found
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                <input
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 rounded-xl border border-stone-200 bg-stone-50 text-sm text-gray-700 outline-none focus:bg-white focus:border-emerald-900 focus:ring-2 focus:ring-emerald-900/10"
                />
                ...
                <div className="relative w-full sm:w-80">
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-stone-200 bg-stone-50 text-sm text-gray-900 placeholder:text-stone-400 outline-none transition focus:bg-white focus:border-emerald-900 focus:ring-2 focus:ring-emerald-900/10"
                  />
                  {searchTerm && (
                    <button
                      type="button"
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#1b3b2b] hover:bg-emerald-950 disabled:bg-stone-300 disabled:cursor-not-allowed text-white text-sm font-bold whitespace-nowrap cursor-pointer transition-colors"
                >
                  {generatingPdf ? (
                    <>
              ...
              <tbody className="divide-y divide-stone-100">
                {filteredSubmissions.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-4">
                      <span
                        className={`inline-flex px-3 py-1 rounded-full text-[11px] font-bold ${getTypeStyle(item.type)}`}
                      >
                        {item.type || "-"}
                      </span>
                    </td>
